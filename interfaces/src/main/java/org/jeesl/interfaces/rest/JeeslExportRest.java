...
{	
	...
	<X extends JeeslMcsStatus<L,D,?,?,?>, RREF extends EjbWithId> org.jeesl.model.xml.jeesl.Container exportMcsStatus(R realm, RREF rref, String code) throws UtilsConfigurationException;
