...
TTE extends JeeslLfTargetTimeElement<L,TTG>>
					...
					implements JeeslLogframeFacade<L,D,R,TTG,TTI,TTE>
{
	private static final long serialVersionUID = 1L;

	final static Logger logger = LoggerFactory.getLogger(JeeslAssetFacadeBean.class);

	private final LfFactoryBuilder<L,D,R,TTG,TTI,TTE> fbLogFrame;

	public JeeslLogFrameFacadeBean(EntityManager em, final LfFactoryBuilder<L,D,R,TTG,TTI,TTE> fbLogFrame)
	{
		super(em);
