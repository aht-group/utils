...
public class JeeslLogFrameFacadeBean<L extends JeeslLang,D extends JeeslDescription,R extends JeeslTenantRealm<L,D,R,?>,
									...
									VM extends JeeslLfValueMonitoring<I,TTG,TTE>,
									LFC extends JeeslLfConfiguration<LF,?>>
					extends JeeslFacadeBean
					implements JeeslLogframeFacade<L,D,R,LF,I,IL,IT,IU,IV,TTG,TTI,TTE,VM,LFC>
{
	private static final long serialVersionUID = 1L;

	final static Logger logger = LoggerFactory.getLogger(JeeslAssetFacadeBean.class);

	protected final LfFactoryBuilder<L,D,R,LF,I,IL,IT,IU,IV,TTG,TTI,TTE,VM,LFC> fbLf;

	public JeeslLogFrameFacadeBean(EntityManager em, final LfFactoryBuilder<L,D,R,LF,I,IL,IT,IU,IV,TTG,TTI,TTE,VM,LFC> fbLf)
	{
		super(em);
		this.fbLf=fbLf;
	}
