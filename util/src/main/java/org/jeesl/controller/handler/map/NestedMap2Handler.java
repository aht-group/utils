...
{
    final static Logger logger = LoggerFactory.getLogger(NestedMap2Handler.class);

	public NestedMap2Handler()
    {
	...
	{
		int size=0;
		for(Map<L2,VALUE> m2 : map.values())
		{
			size=size+m2.size();
		}
		return size;
...
//	
    ...
    {
		if(!containsKey(map,l1,l2)) {return null;}
