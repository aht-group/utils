		...
		implements Serializable,SbToggleBean
{
	...
	protected DB dashboard; public DB getDashboard() {return dashboard;} public void setDashboard(DB dashboard) {this.dashboard = dashboard;}
	...
	public AbstractIoDashboardBean(final IoDashboardFactoryBuilder<L,D,DBR,DB,DBC> fbDashboard)
	{
		...
		comparatorDashboard = (new DashboardComparator<L,D,DB,DBR>()).factory(DashboardComparator.Type.code);
	}
